...
const buttonVariants = cva(
  'inline-flex font-inter text-base items-center justify-center gap-2 whitespace-nowrap duration-100 cursor-pointer outline-0 focus-visible:outline-3',
  {
    variants: {
      variant: {
        default:
          'rounded-4xl bg-purple-600 font-normal text-white transition-all hover:bg-purple-700 focus-visible:outline-white active:bg-purple-800 disabled:bg-purple-600/50',
        loading:
